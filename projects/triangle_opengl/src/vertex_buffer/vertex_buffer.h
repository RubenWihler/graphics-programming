...
/// @param buffer Pointeur vers le vertex buffer à initialiser
...
/// @param buffer Pointeur vers le vertex buffer à détruire
...
/// @param buffer Pointeur vers le vertex buffer à bind
...
/// @param buffer Pointeur vers le vertex buffer à unbind
